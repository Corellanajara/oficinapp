...
exports.routesConfig = function (app) {
  ...
  app.post('/api/clientes',(req, res) => {
    let data = {estado:true,nombre: req.body.nombre, giro: req.body.giro,rut:req.body.rut,direccion:req.body.direccion,comuna:req.body.comuna,ciudad:req.body.ciudad,contacto:req.body.contacto,tipoCompra:req.body.tipoCompra,idEmpresa : req.headers.idempresa,usuario:req.body.idUsuario};
